...
public class AgentManager {
    ...
    public JsonObject readAgentConfig() throws IOException {
        ...
        try (InputStreamReader reader = new InputStreamReader(new FileInputStream(agentFile), java.nio.charset.StandardCharsets.UTF_8)) {
    ...
    public void writeAgentConfig(JsonObject config) throws IOException {
        ...
        Path agentPath = pathManager.getAgentFilePath();
        try (OutputStreamWriter writer = new OutputStreamWriter(new FileOutputStream(agentPath.toFile()), java.nio.charset.StandardCharsets.UTF_8)) {
